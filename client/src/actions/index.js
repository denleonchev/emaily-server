...
import { FETCH_USER, FETCH_SURVEYS, SET_SEARCH, SET_IS_FETCHING_SURVEYS, SET_INITIAL_FETCHING_SURVEYS, SELECT_SURVEY } from './types'
...
export const selectSurvey = (value) => (
  {
    type: SELECT_SURVEY,
    payload: value
  }
